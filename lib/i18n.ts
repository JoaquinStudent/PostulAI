...
const en: Dict = {
  ...
  // Usage
  "Consumo de IA": "AI Consumption",
  "Consumo real de esta sesión. Se resetea al cerrar la pestaña.": "Real consumption for this session. Resets when you close the tab.",
  "Llamadas AI": "AI Calls",
  "Costo estimado": "Estimated cost",
  "Desglose por operación": "Breakdown by operation",
  "Operación": "Operation",
  "Últimas llamadas": "Recent calls",
  Limpiar: "Clear",
  "Sin consumo todavía. Analiza una convocatoria para empezar.": "No consumption yet. Analyze a call to get started.",
...
const pt: Dict = {
  ...
  "Consumo de IA": "Consumo de IA",
  "Consumo real de esta sesión. Se resetea al cerrar la pestaña.": "Consumo real desta sessão. Reseta ao fechar a aba.",
  "Llamadas AI": "Chamadas AI",
  "Costo estimado": "Custo estimado",
  "Desglose por operación": "Detalhamento por operação",
  "Operación": "Operação",
  "Últimas llamadas": "Chamadas recentes",
  Limpiar: "Limpar",
  "Sin consumo todavía. Analiza una convocatoria para empezar.": "Sem consumo ainda. Analise uma vaga para começar.",
  Continuar: "Continuar",
  Siguiente: "Próximo",
  Volver: "Voltar",
  Cancelar: "Cancelar",
...
const fr: Dict = {
  ...
  "Consumo de IA": "Consommation IA",
  "Consumo real de esta sesión. Se resetea al cerrar la pestaña.": "Consommation réelle de cette session. Se réinitialise à la fermeture de l'onglet.",
  "Llamadas AI": "Appels IA",
  "Costo estimado": "Coût estimé",
  "Desglose por operación": "Détail par opération",
  "Operación": "Opération",
  "Últimas llamadas": "Appels récents",
  Limpiar: "Effacer",
  "Sin consumo todavía. Analiza una convocatoria para empezar.": "Aucune consommation. Analysez un appel pour commencer.",
  Continuar: "Continuer",
  Siguiente: "Suivant",
  Volver: "Retour",
  Cancelar: "Annuler",
